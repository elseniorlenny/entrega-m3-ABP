...
/* Funcion que pide un numero al usuario y lo retorna */
function pedirNumero(mensaje) {
    return Number(prompt(mensaje));
}

/* Funcion que calcula area de un rectangulo */
function calcularArea(largo, ancho) {
    return largo * ancho;
}

/* Funcion que calcula el area total de varias placas */
function calcularAreaTotal(areaPlaca, cantidad) {
    return areaPlaca * cantidad;
}

/* Funcion que calcula cuantas piezas caben en un area total */
...
/* Calcular areas usando las funciones */
...
console.log("Area de la placa: " + areaPlaca + " cm2");
